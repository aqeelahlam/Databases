...
BEGIN
    ...
    ELSE
        RAISE_APPLICATION_ERROR(-20000, 'Please enter a valid expiry date');
    END IF;
END;
/
...
-- DATE LESS THAN CURRENT LIC EXPIRY DATE- IT WILL NOT BE ENTERED INTO THE SYSTEM
SELECT LIC_FNAME, LIC_EXPIRY FROM DRIVER WHERE LIC_NO = '100010';

UPDATE DRIVER
SET LIC_EXPIRY = TO_DATE('03-Jan-2023', 'DD-MON-YYYY')
WHERE LIC_NO = '100010';

SELECT LIC_FNAME, LIC_EXPIRY FROM DRIVER WHERE LIC_NO = '100010';

-- DATE MORE(30 AND MORE MONTHS) THAN CURRENT LIC EXPIRY DATE- IT WILL BE ENTERED INTO THE SYSTEM

SELECT LIC_FNAME, LIC_EXPIRY FROM DRIVER WHERE LIC_NO = '100010';

UPDATE DRIVER
SET LIC_EXPIRY = TO_DATE('03-Jan-2030', 'DD-MON-YYYY')
WHERE LIC_NO = '100010';
