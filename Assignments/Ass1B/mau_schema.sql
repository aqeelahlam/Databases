...
COMMENT ON COLUMN sale.exhibition_date_started IS
    'Date Exhibition Started';
...
ALTER TABLE sale
    ADD CONSTRAINT "EXHIBITION-SALE" FOREIGN KEY ( exhibition_date_started,
                                                   artwork_no,
                                                   artist_code )
        REFERENCES exhibition ( exhibition_date_started,
                                artwork_no,
                                artist_code );
